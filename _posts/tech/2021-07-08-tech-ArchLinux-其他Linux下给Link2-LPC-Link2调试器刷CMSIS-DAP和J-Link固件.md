---
layout: post
title: ArchLinux/其他Linux下给Link2/LPC-Link2调试器刷CMSIS-DAP和J-Link固件
category: 科技
tags: [Arch , linux , Link2, LPC-Link2, CMSIS-DAP, J-Link]
keywords: Arch , linux , Link2, LPC-Link2, CMSIS-DAP, J-Link
description:  ArchLinux/其他Linux下给Link2/LPC-Link2调试器刷CMSIS-DAP和J-Link固件
---
...
[https://www.nxp.com/design/microcontrollers-developer-resources/lpcscrypt-v2-1-2:LPCSCRYPT](https://www.nxp.com/design/microcontrollers-developer-resources/lpcscrypt-v2-1-2:LPCSCRYPT)
...
### 7. 编译 `PKGBUILD` 并安装验证
 如果需要更新 `PKGBUILD` 中`sha256sums` 校验值
...
[https://aur.archlinux.org/packages/lpcscrypt-bin/](https://aur.archlinux.org/packages/lpcscrypt-bin/)


### [传送门](https://blog.csdn.net/taotieren/article/details/118461519)
